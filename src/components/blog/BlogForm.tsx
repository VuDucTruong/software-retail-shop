...
const MESSAGES = {
  required: {
    title: 'Input.error_title_required', subtitle: "Input.error_subtitle_required",
    content: "Input.error_content_required",
  },
  max: {
    title: "Input.error_title_40", subtitle: "Input.error_subtitle_50",
    content: "Input.error_content_1000"
  },
  valid: {
    image: "Input.error_image_file_only"
  }
}

export const BlogFormSchema = RequiredSchema.extend({
  title: z.string().min(1, MESSAGES.required.title).max(40, MESSAGES.max.title),
  subtitle: z.string().min(1, MESSAGES.required.subtitle).max(50, MESSAGES.max.subtitle),
  approvedAt: z.string().nullish(),
  content: z.string().min(1, MESSAGES.required.content).max(1000, MESSAGES.max.content),
  author: z.object({
    id: z.number(),
    fullName: z.string()
  }),
