  ...
  const cols: ColumnDef<Payment>[] = [
    {
      ...
      },
      {
        ...
        cell: ({ row }) => {
          return <div className="font-bold">{row.original.paymentMethod}</div>;
        },
      },
      {
        accessorKey: "Amount",
        header: t("Amount"),
        cell: ({ row }) => {
          return <div className="font-bold">{row.original.amount}</div>;
        },
      },
      {
        accessorKey: "Status",
        header: t("Status"),
        cell: ({ row }) => {
          return <div className="font-bold">{row.original.status}</div>;
        },
      },
      {
        ...
        header: t("Time"),
        cell: ({ row }) => {
          return <div className="font-bold">{row.original.createAt}</div>;
        },
      },
  ];
