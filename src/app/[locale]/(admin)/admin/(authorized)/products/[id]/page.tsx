...
const sampleProduct: Product = {
  ...
  imageUrl: "/banner.png",
  description: [
    { title: "text", content: "This is a sample product." },
    { title: "image", content: "/images/sample-product.jpg" },
  ],
  tags: ["sample", "product"],
  categories: [
...
export default function EditProductPage() {
  ...
  const form = useForm<ProductUpdate>({
    defaultValues: {
      ...convertProductToProductUpdate(sampleProduct),
    },
            ...
            <FormField
              ...
              render={() => (
                ...
                >
                  <EditAvatarSection
                    ref={fileRef}
                    defaultAvatar={sampleProduct.imageUrl}
                    name={t("upload_image")}
